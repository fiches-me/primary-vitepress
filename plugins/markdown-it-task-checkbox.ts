 ...
 */
export function taskCheckboxPlugin(md: MarkdownRenderer): void {
  ...
  md.core.ruler.after("inline", "custom-task-checkboxes", (state) => {
    ...
    for (let i = 0; i < tokens.length; i++) {
      ...
      if (checkboxIndex === -1 || !taskChar) continue;
